...
namespace Sunc.Framework.Repository.Utility
{
    ...
    public class Encrypt
    {
        ...
        public static string Encode(string encryptString, string encryptKey = "SupperMirco")
        {
        ...
        public static string Decode(string decryptString, string decryptKey = "SupperMirco")
        {
            try
            {
